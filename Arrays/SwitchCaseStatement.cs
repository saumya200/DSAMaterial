    ...
    class SwitchCaseStatement
    {
        ...
        class Program
        {
            static void Main()
            {
                ...
                List<double> circle = new List<double> { 5 };
                Console.WriteLine(SwitchCase(1, circle));

                List<double> rectangle = new List<double> { 5, 10 };
                Console.WriteLine(SwitchCase(2, rectangle));
            }
